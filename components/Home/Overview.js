                        ...
                        <div className="col-lg-6 col-md-6 overview-content">
                            <div className="features-holder-content">
                                <div className="section-title">
                                    <h2>Connect With DSC UPT</h2>
                                    <div className="bar" />
                                    <p>
                                        Meet other students on campus interested in similar projects/ technologies. All
                                        are welcome, including those with diverse technical backgrounds and different
                                        branches.
                                    </p>
                                </div>
                            </div>
                ...
                <div className="overview-box">
                    <div className="row h-100 justify-content-center align-items-center">
                        ...
                        <div className="col-lg-6 col-md-6 overview-content">
                            <div className="features-holder-content">
                                <div className="section-title">
                                    <h2>Grow With DSC UPT</h2>
                                    <div className="bar" />
                                    <p>
                                        Apply your new learnings and connections to build great solutions for local
                                        problems. Advance your skills, career and network. Give back to your community
                                        by helping others learn as well.
                                    </p>
                                </div>
                            </div>
                        </div>
