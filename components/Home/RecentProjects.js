            ...
            <section className="project-area pt-50">
                <div className="container">
                    <div className="section-title">
                        ...
                        <div className="bar" />
                        <p>The below projects are some of our recent projects in DSC VJIT</p>
                    </div>
                </div>
                {error ? (
                    <></>
                    ...
                    <div className="row m-0">
                        {display ? (
                            <OwlCarousel className="project-slides owl-carousel owl-theme" {...options}>
                                {numberArray.map((item, index) => (
                                    <div className="col-lg-12" key={index}>
                                        <div className="single-project">
                                            <div className="project-image">
                                                <Skeleton className={'recent-projects'} variant="rect" width={'100%'} />
                                            </div>
                            ...
                            <OwlCarousel className="project-slides owl-carousel owl-theme" {...options}>
                                {data.data.map((project) => (
                                    <div className="col-lg-12" key={project.id}>
                                        ...
                                        >
                                            <div className="project-image">
                                                <img className={'recent-projects'} src={project.image} alt="work" />
                                            </div>
