...
import dscLogoVertical from '../../images/dscLogoVertical.png';
...
function Footer() {
    const url = 'https://now.us18.list-manage.com/subscribe/post?u=ee029133db34e212d0c46034f&amp;id=5c571b066e';
    ...
    return (
        <footer className="footer-area bg-image">
            ...
            {/*            <Subscribe status={status} message={message} onSubmitted={(formData) => subscribe(formData)} />*/}
            {/*        )}*/}
            {/*    />*/}
            {/*</NoSSR>*/}
                    ...
                    <Grid container direction="column" justify={'center'} alignItems={'center'} spacing={2}>
                        <Grid item>
                            <div className="single-footer-widget">
                                <Link href="/">
                                    <a className="logo pt-5 pb-3">
                                        <img src={dscLogoVertical} alt="logo" />
                                    </a>
                                </Link>
                            </div>
                        </Grid>
