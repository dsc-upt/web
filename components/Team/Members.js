        ...
        <section className="team-area ">
            <div className="container">
                <div className="row">
                    {teamStatus === 'error' ? (
                        <>
                            Unable to fetch the members due to an error: <strong>{teamData}</strong>
                        </>
                    ) : teamStatus === 'loading' ? (
                                                ...
                                                {Object.keys(member['socialLinks']).map((website) =>
                                                    member['socialLinks'][website] !== '' ? (
                                                        <li className={'socialTeamIcon'} key={website}>
                                                            <a href={member['socialLinks'][website]} target={'_blank'}>
                                                                {website === 'facebook' ? (
                        ...
                        <>
                            ...
                            Hey Buddy, you broke the system, use the application in a correct way
                        </>
                    )}
                </div>
